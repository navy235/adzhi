namespace CodeFirstEF.Migrations
{
    ...
    public partial class AddMembersCore : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        MemberID = c.Int(nullable: false, identity: true, defaultValue: 200000),
                        Email = c.String(nullable: false, maxLength: 50),
                        NickName = c.String(nullable: false, maxLength: 50),
                        Password = c.String(nullable: false, maxLength: 50),
                        GroupID = c.Int(nullable: false),
                        LastTime = c.DateTime(nullable: false),
                        LastIP = c.String(nullable: false, maxLength: 50),
                        AddTime = c.DateTime(nullable: false),
                        AddIP = c.String(nullable: false, maxLength: 50),
                ...
                c => new
                    {
                        ...
                        Namespace =  c.String(nullable: false, maxLength: 50),
                ...
                c => new
                    {
                        ...
                        Name = c.String(nullable: false, maxLength: 50),
                        Description = c.String(nullable: false, maxLength: 150),
                        Leader = c.String(nullable: false, maxLength: 50),
                    })
                ...
                c => new
                    {
                        MemberID = c.Int(nullable: false),
                        ID = c.Int(nullable: false, identity: true),
                        AvtarUrl = c.String(nullable: false, maxLength: 500),
